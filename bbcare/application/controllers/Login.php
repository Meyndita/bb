	...
	class Login extends CI_Controller {
		...
		public function reg_process_pengasuh()
		{
		  ...
		  if ($update > 0) {
			  ...
			  <p>Terimakasih sudah melakukan registrasi, <br> untuk tahap selanjutnya silahkan klik <a href='" . base_url() . "Login/verify_email_pengasuh/" . $verification_key . "'>link</a>. untuk melakukan registrasi akun dan mendapatkan username dan password akun anda</p>
			  <p><a href='" . base_url() . "Login/verify_email_pengasuh/" . $verification_key . "'>" . base_url() . "Login/verify_email_pengasuh/" . $verification_key . "</a></p>
			  <p>Terimakasih,</p>";
