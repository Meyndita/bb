		...
		<div class="container-login100">
			...
			<div class="login100-form validate-form"> 
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input type="text" name="nik" class="form-control" id="exampleLastName" placeholder="Nik" required>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Nama Pengasuh</span>
						<input type="text" name="nama_pengasuh" class="form-control" id="exampleLastName" placeholder="Nama Pengasuh" required>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
